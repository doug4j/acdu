...
var installProcessConnectorCmd = &cobra.Command{
	Use:     "connector",
	Short:   "Installs Process Connectors for the given process. [NOT IMPLEMENTED]",
	Long:    `Installs Process Connectors for the given process.`,
